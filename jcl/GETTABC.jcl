...
//************************************************************          00012002
//* COMMON FILE DATA SET                                     *          00013002
//************************************************************          00014002
//DELETE   EXEC PGM=IEFBR14                                             00015002
//SYSPRINT DD SYSOUT=*                                                  00016002
//SYSOUT   DD SYSOUT=*                                                  00017002
//SYSDUMP  DD SYSOUT=*                                                  00018002
//DD1      DD DSN=&SYSUID..CAP.UPDATE,                                  00019002
//            DISP=(MOD,DELETE,DELETE),                                 00019102
//            SPACE=(TRK,(0)),                                          00019202
//            UNIT=SYSDA,                                               00019302
//            VOL=SER=DEVHD1,                                           00019402
//            DCB=(DSORG=PS,RECFM=FB,LRECL=207,BLKSIZE=20700)           00019502
//ALLOC    EXEC PGM=IEFBR14                                             00019602
//SYSPRINT DD SYSOUT=*                                                  00019702
//SYSOUT   DD SYSOUT=*                                                  00019802
//SYSDUMP  DD SYSOUT=*                                                  00019902
//DD2      DD DSN=&SYSUID..CAP.UPDATE,                                  00020002
//            DISP=(NEW,CATLG,DELETE),                                  00020102
//            SPACE=(TRK,(1,1),RLSE),                                   00020202
//            UNIT=SYSDA,                                               00020302
//            VOL=SER=DEVHD1,                                           00020402
//            DCB=(DSORG=PS,RECFM=FB,LRECL=207,BLKSIZE=20700)           00020502
//*                                                                     00021000
...
//             MEMBER=GETTAB                   <= SOURCE MEMBER         00074001
//*                                                                     00076000
...
DSN SYSTEM (DBC1   )                                                    00400000
  RUN PROGRAM   (GETTAB) -                                              00410001
      PLAN      (MATEGDA ) -                                            00420000
      LIBRARY   ('MATEGD.CAP.LOAD')                                     00430000
END                                                                     00440000
/*                                                                      00450000
//UFILE    DD DSN=&SYSUID..CAP.UPDATE,DISP=SHR                          00460001
